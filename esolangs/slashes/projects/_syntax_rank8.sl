...
=       [8]{+_sort:cur_t_tmp}{_sort:m_tmp}'2;[8]{_sort:m_tmp}'2;{+_sort:cur_t_tmp}[8]
=       [3]
=     [3]<_sF:{_sort:m_tmp}'2;>[3]
=       [8]{+_sort:cur_t_tmp}{_sort:m_tmp}'2;[8]{+_sort:cur_f_tmp}{_sort:m_tmp}'2;[8]
=       [3]
=     /
= 
=   /###/ _sort:* :: R2 -> (R1 -> R6) /
...
= 
=   /{+_sort:cur_t_tmp}/{+sort:cur}{_sort:tmp}'2;/
=   /{+_sort:cur_f_tmp}/{_sort:tmp}'2;{+sort:cur}/
= 
=   /###/ sort:* :: R5 -> R4 /
=   /<sort:A>/<_sF:A><_sF:B><_sF:C><_sF:D>/ -> /{_sort:tmp}'1;/A/
=   /<sort:B>/<_sT:A><_sF:B><_sF:C><_sF:D>/ -> /{_sort:tmp}'1;/B/
=   /<sort:C>/<_sT:A><_sT:B><_sF:C><_sF:D>/ -> /{_sort:tmp}'1;/C/
=   /<sort:D>/<_sT:A><_sT:B><_sT:C><_sF:D>/ -> /{_sort:tmp}'1;/D/
= 
= 
=  /###/ R6 - Define <complex injector1> to R3 /
=   /###/ _flip :: R6 (_flip:tmp) -> R5 /
=   /<_flip>/
=     [6]{+_flip:cur_tmp}{+flip:stop}[6]{+flip:stop}{+_flip:tmp}[6]
=     [6]{+_flip:cur_tmp}A[6]A{+_flip:cur_tmp}[6]
=     [6]{+_flip:cur_tmp}B[6]B{+_flip:cur_tmp}[6]
=     [6]{+_flip:cur_tmp}C[6]C{+_flip:cur_tmp}[6]
=     [6]{+_flip:cur_tmp}D[6]D{+_flip:cur_tmp}[6]
=     /
...
=     /###/ multiply_flip :: R4 -> R3 /
=     /<multiply_flip>/
=       [4][{+flip:name}^[4][+{+flip:name}][{+flip:name}[4]
=       [4]#{+flip:name}^[4]#{+flip:name}>#{+flip:name}[4]
=       /
= 
= 
