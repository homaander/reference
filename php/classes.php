...
// Отражение
  ...
  $obj = new ReflectionMethod(B::class, 'myMethod');
  ...
  // Классы
    ...
    // PHP 8
      // Attributes
        ...
        #[A('1', about: 'Hello world')]
        class B {
          #[A('22', about: 'Hello world 22')]
        ...
        var_dump($c->getAttributes(A::class)[0]->newInstance());

        $m = new ReflectionMethod(B::class, 'test');
        var_dump($m->getAttributes()[0]->newInstance());
